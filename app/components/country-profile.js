...
export default function CountryProfile(props) {
  ...
  return (
    <Flex direction={"column"}>
      <BackButton ReturnPage="/country-profiles" />
        ...
        <Table.Tbody>
          <Table.Tr>
            ...
            <Table.Td>
              {" "}
              {FormatBigNumber(
                Math.trunc(CountryData[Country]["2023"]["Gdp per capita"]),
              )}{" "}
              €
            </Table.Td>
          </Table.Tr>
          ...
          <Table.Tr>
            ...
            <Table.Td>
              {" "}
              {FormatBigNumber(
                Math.trunc(CountryData[Country]["2023"]["Gdp per capita PPP"]),
              )}{" "}
              €
            </Table.Td>
          </Table.Tr>
          ...
          <Table.Tr>
            ...
            <Table.Td>
              {FormatBigNumber(
                Math.trunc(
                  CountryData[Country]["2023"]["Net average monthly wage"],
                ),
              )}{" "}
              €
            </Table.Td>
          ...
          <Table.Tr>
            ...
            <Table.Td>
              {Math.trunc(CountryData[Country]["2023"]["Debt to gdp"])} %
            </Table.Td>
          </Table.Tr>
          ...
          <Table.Tr>
            ...
            <Table.Td>
              {Math.trunc(CountryData[Country]["2023"]["Corporate tax"])} %
            </Table.Td>
          </Table.Tr>
          ...
          <Table.Tr>
            ...
            <Table.Td>
              {Math.trunc(CountryData[Country]["2023"]["Capital gains tax"])} %
            </Table.Td>
          </Table.Tr>
          ...
          <Table.Tr>
            ...
            <Table.Td>
              {Math.trunc(CountryData[Country]["2023"]["Value added tax"])} %
            </Table.Td>
          </Table.Tr>
          ...
          <Table.Tr>
            ...
            <Table.Td>
              {Math.trunc(
                CountryData[Country]["2021"]["R&D (Innovation) to gdp"] * 100,
              ) / 100}{" "}
              %
            </Table.Td>
          </Table.Tr>
      ...
      <Table variant="vertical" layout="fixed">
        <Table.Tbody>
          ...
          <Table.Tr>
            ...
            <Table.Td>
              {Math.trunc(CountryData[Country]["2023"]["Voting participation"])}{" "}
              %
            </Table.Td>
          </Table.Tr>
          ...
          <Table.Tr>
            ...
            <Table.Td>
              {Math.trunc(CountryData[Country]["2010"]["Religiosity"])} %
            </Table.Td>
          </Table.Tr>
          ...
          <Table.Tr>
            ...
            <Table.Td>
              {Math.trunc(CountryData[Country]["2023"]["Risk of poverty"])} %
            </Table.Td>
          </Table.Tr>
          ...
          <Table.Tr>
            ...
            <Table.Td>
              {Math.trunc(CountryData[Country]["2023"]["Tertiary education"])} %
            </Table.Td>
          </Table.Tr>
          ...
          <Table.Tr>
            ...
            <Table.Td>
              {Math.trunc(CountryData[Country]["2022"]["Pisa score"])}
            </Table.Td>
          </Table.Tr>
